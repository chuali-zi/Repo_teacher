...
- **[DeepTutor](https://github.com/Deep-Tutor/DeepTutor)** — 本项目的直接上游。Repo Tutor 借鉴了 DeepTutor 的agent和tool call等的核心思路，并在此基础上重写了内核与前端。原始作者及其贡献者在此一并致谢。许可证：Apache License 2.0。
